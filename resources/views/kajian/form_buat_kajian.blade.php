    ...
    <form action="/kajian" method="POST">
        ...
        <div class="container bg-white bg-opacity-25 rounded-4 shadow-sm col-8 mx-auto py-4">
            ...
            <form>
              ...
              <div class="row my-3">
                <label for="pemateri" class="col-2"><img src="{{asset('assets/kajian_img/person.svg')}}" class="float-end w-50 h-50 mt-1"></label>
                <div class="col-sm-9">
              ...
              <div class="row my-3">
                <label for="waktu" class="col-2"><img src="{{asset('assets/kajian_img/date.svg')}}" class="float-end w-50 h-50 mt-1"></label>
                <div class="col-sm-9">
